...
<head>
<title>Expertum - Your new hospital manager</title>
<meta charset="utf-8">
			...
			<div class="contactstyle topform">										
				<form method="post" action="contact/topcontact.php" id="topcontactform">
					<div class="form">
						...
						<input type="submit" id="submit" class="clearfix btn" value="Request an appointment">
					</div>
				</form>
				<div class="done">
...
<!-- Sign-in
================================================== -->
<section id="sign_in" class="margintop60 nopadding" style="background-color:#FFFFFF;">
		<div class="col-md-6 whitetext" style="padding: 60px;">
			<div class="textwidget">
			<h1 class="toptitle">Sign in <br/><i class="fa fa-star roundicon"></i>
			</h1>								
			<div class="contactstyle topform">										
				<form method="post" action="signin.php" class="form_design" id="signinform">
					<div class="form">
						<input type="text" name="name" placeholder="Name *">
						<input type="text" name="password" placeholder="Password (8 characters)">
						<input type="submit" id="submit" class="clearfix btn" value="Request Access">
					</div>
				</form>
				<div class="done">
					<div class="alert alert-success">
